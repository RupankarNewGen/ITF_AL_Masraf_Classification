...
if __name__ == '__main__':
	...
	df = pd.read_csv(os.path.join("/home/ntlpt-42/Documents/mani_projects/IDP/Trade_finance_end_to_end_test/Final_data_training_layoutlmv2/PL/val_data/result_path/BOL_analysis_pre_valid_May30_after_fuzzy_match_post-processing.csv"))
	...
	if not os.path.exists(res_path):
		os.mkdir(res_path)
	name = "final_report_BOL_pre_May11_after_fuzzy_match_change" + ".csv"
