...
def get_ocr_vision_api(image_path):
    os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = "/home/ntlpt-42/Documents/mani_projects/IDP/IDE/Error_analysis_STP_generation/Layoutlmv3_performance_phase_1_data/layoutlmv3_result_generation_script/Trade-Finance-main/src/main/oval-heuristic-387906-1815ed6ee296.json"
...
if __name__== "__main__":
    ...
    folder_path = "/home/ntlpt-42/Documents/mani_projects/IDP/IDE/Geolayoutlm/CS_complete_data/new_data_prep/ROOT_CS"
    ...
    labelled_files = os.listdir(images_path)
    labelled_files = [x.split("_linking.png")[0] for x in labelled_files]

    annotation_data = []
    thresh = 300
    count= 1
    for file in labelled_files:
        if os.path.exists(os.path.join(images_path, file + "_linking.png")):
            print('yes')
            print(f'file name: {file}')
            # master_files = os.listdir(master_path)
            #doc = fitz.open(os.path.join(pdf_path, file + ".pdf"))
            image = cv2.imread(os.path.join(images_path, file + "_linking.png"))
            word_coordinates = []
            word_coordinates, all_text = get_ocr_vision_api(os.path.join(images_path, file + "_linking.png"))
            ...
            if len(word_coordinates) == 0:
                ...
                shutil.copy(os.path.join(images_path, file + "_linking.png"), os.path.join(master_path, file + "_linking.png"))
