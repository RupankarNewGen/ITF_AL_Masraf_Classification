...
def __preprocess__(data:dict,thresh: int):
        ...
        for i, item in enumerate(data):
            ...
            if  (i+1)%thresh==0:
                print("appending to the final_result")
                ###################################################################
                ###################################################################
...
def main(all_words):
    ...
    '''
    root_path = "/home/ntlpt19/Downloads/MERGED_DATA/GEO_Latest/geolayoutlm_code_base_2/CI_EVAL"
    ...
    if len(key_dict)<=150:
        ...
        final_result = __preprocess__(key_dict, 150)
        print(final_result)
    return final_result
...
if __name__=="__main__":
    ...
    preproces_root_path= "/home/ntlpt19/Downloads/MERGED_DATA/GEO_Latest/geolayoutlm_code_base_2/CI_EVAL/val_inference_files"
